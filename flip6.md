...
### [What We Have Been Doing](https://medium.com/@BCHArgentina/what-bitcoin-cash-argentina-has-done-40b831b776ff)
...
- **Activity filters:** Prioritize businesses showing the clearest signs of actual use.
- **Tools for reporting businesses:** Notify the platform when a business no longer accepts BCH or needs corrections.
- **Discount display:** Highlight active promotions and make it easier for users to find specific benefits.
- **Search by products or keywords:** Find businesses not only by name, but also by what they sell or the services they offer.
- **Business categories:** Classify the specific type of business, such as dining, tourism, computing, clothing, or bookstores.
- **Business types:** Distinguish the nature of the business. For example, a coffee shop or a retail store would be classified as a physical business; a lawyer or a plumber who provides in-person service would be classified as an in-person service; and a web designer or an online platform would be classified as a digital service.
- **Sorting by proximity:** See the nearest businesses first when location is enabled, including the exact distance in kilometers from each business.
- **Integration into websites and apps:** Expand the map’s reach and make it easier to use from other environments within the ecosystem.
...
At BCH Argentina, we aim to drive real-world adoption of Bitcoin Cash by combining in-person events, digital campaigns, and partnerships with merchants.
...
At BCH Argentina, we strive to maintain and improve our digital tools to organize the community, promote the adoption of Bitcoin Cash, and facilitate its everyday use in Argentina.
